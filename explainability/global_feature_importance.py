...
class GlobalFeatureImportance:
    def __init__(self, importance_dict, feature_label_dict ,information_string):
        ...
        self.node_typeto_color_char = {"graph_1": "#CC0000", "graph_2": "#0075E8", "faz": "#007E01"}
    ...
    def get_combined_features(self):
        ...
        for key in self.importance_dict.keys():
            ...
            res = sorted(zip(self.importance_dict[key], self.feature_label_dict[key]), key=lambda pair: pair[0], reverse = True)
    ...
    def combined_feature_plot(self, num_features = 10):
        ...
        ax.bar([f[0] for f in combined_features], [f[1] for f in combined_features], color = color_list)
