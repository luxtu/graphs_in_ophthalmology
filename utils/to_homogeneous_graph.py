...
def to_vessel_graph(hetero_dataset):
    ...
    for i in range(len(hetero_dataset)):
        ...
        vessel_graph_data = Data(x=hetero_data["graph_1"].x, edge_index=hetero_data["graph_1", "to", "graph_1"].edge_index, y=hetero_data.y, pos = hetero_data["graph_1"].pos)
...
def to_void_graph(hetero_dataset):
    ...
    for i in range(len(hetero_dataset)):
        ...
        void_graph_data = Data(x=hetero_data["graph_2"].x, edge_index=hetero_data["graph_2", "to", "graph_2"].edge_index, y=hetero_data.y, pos = hetero_data["graph_2"].pos)
