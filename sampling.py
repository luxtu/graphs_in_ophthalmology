...
def random_node_neighbor(graph, sample_size, start_nodes):
    """
...
def random_walk(graph, sample_size, start_nodes, c = 0.15):
    """
...
def random_jump(graph, sample_size, start_nodes, c = 0.15):
    """
    Performs a random walk for each provided start_node. The random walk stops when the discovered nodes are as large as the sample size. 
...
def randomGeomSubgraphs(G, label, starts = 1000, node_sample_size = 400, mode = "rnn"):
    """
    Performs a random walk for each provided start_node. The random walk stops when the discovered nodes are as large as the sample size. 
    ...
    if mode == "rnn":
        R_walks = random_node_neighbor(G, sample_size = node_sample_size, start_nodes = starts)
    elif mode == "rw":
        R_walks = random_walk(G, sample_size = node_sample_size, start_nodes = starts, c= 0.0)
    elif mode == "rj":
        R_walks = random_jump(G, sample_size = node_sample_size, start_nodes = starts, c= 0.1)
    else:
