...
void_graph_path_octa500 = f"../../OCTA_500_RELEVANT_fix/void_graph_faz_more_features" # _more_features
hetero_edges_path_octa500 = f"../../OCTA_500_RELEVANT_fix/hetero_edges_faz"
faz_node_path_octa500 = f"../../OCTA_500_RELEVANT_fix/faz_node"
faz_region_edge_path_octa500 = f"../../OCTA_500_RELEVANT_fix/faz_region_edges"
faz_vessel_edge_path_octa500 = f"../../OCTA_500_RELEVANT_fix/faz_vessel_edges"
...
octa500_pickle = f"../../OCTA500_cv_more_features.pkl" 
octa500_dataset = hetero_graph_loader_faz.HeteroGraphLoaderTorch(graph_path_1=vessel_graph_path_octa500,
...
seg_folder = f"../../OCTA_500_RELEVANT_fix/segs"
seg_size = 1216

octa500_dataset_cl = prep.add_centerline_statistics_multi(octa500_dataset, image_path, json_path, seg_size)

# clean the data
octa500_dataset.hetero_graph_list = prep.hetero_graph_cleanup_multi(octa500_dataset_cl)

octa500_dataset_dict = dict(zip([graph.graph_id for graph in octa500_dataset.hetero_graph_list], octa500_dataset.hetero_graph_list))

# set the dictionaries
octa500_dataset.hetero_graphs = octa500_dataset_dict

octa500_processed = f"../../OCTA_500_RELEVANT_fix/all_OCTA500_selected_sweep_repeat_v2.pkl"
