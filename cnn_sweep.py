from torchvision.models import resnet18, ResNet18_Weights, efficientnet_b3, EfficientNet_B3_Weights, efficientnet_b2, EfficientNet_B2_Weights
...
sweep_configuration = {
    "method": "random",
    "name": "cnn_sweep_pretrained_effnetb2",
    "metric": {"goal": "maximize", "name": "best_mean_auc"},
    "parameters": {
        "model" : {"values": ["resnet", "effnet"]},
        "batch_size": {"values": [8, 16, 32, 64]},
        "epochs": {"values": [200]},
        "lr": {"max": 0.005, "min": 0.0001}, # learning rate to high does not work
        "weight_decay": {"max": 0.02, "min": 0.005},
